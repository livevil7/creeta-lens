...
| PreToolUse | Before AskUserQuestion | `hooks/pre-tool-ask.js` | **v3.39** — denies a question dialog with no report written since the last tool result (<40 chars). Fail-open. `LENS_ASK_GUARD=0` |
