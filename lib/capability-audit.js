/**
 * Lens - Capability Audit State (for /cr modernization audit)
 *
 * Tracks when the last /cr self-audit ran, scoped to the Lens repo so the
 ...
 *   - skills/cr/SKILL.md      → `node lib/capability-audit.js stamp` (on audit done)
 *
...
/** Record an audit run. Called by /cr at the end via the `stamp` CLI. */
