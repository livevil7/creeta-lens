 ...
 * Priority: config override → ~/.claude/creet/ (stable across sessions)
 */
function getMemoryPath(configPath) {
  ...
  // Stable path under CLAUDE_HOME or ~/.claude/creet/
  const claudeHome = process.env.CLAUDE_HOME || path.join(os.homedir(), '.claude');
  return path.join(claudeHome, 'creet', DEFAULT_MEMORY_FILE);
}
