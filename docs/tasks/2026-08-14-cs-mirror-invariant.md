...
- **재개 포인트**: T9 잔여 — ① ERP sync PR #1·#2 머지 여부(=배포, 대표 결정) ② agent/ PR 3건 결정 ③ 장기 방치 브랜치(openclaw 176일·namane-cms main 136일 등) 정리 여부 ④ Mac Mini `/lens-upgrade`
- **T9 실측**: PR #3 머지(722321f)·태그 v3.31.0 푸시·로컬 캐시 3.31.0 배포(스크립트 md5 일치)·실워크스페이스 32레포 런 — 성공 29/32, **boost sync PR #2(21일 방치) 자동 회수 실증**, ERP 2건 정책 보류, 비-base 브랜치 26개 나이 노출
