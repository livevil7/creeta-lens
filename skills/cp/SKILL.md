---
name: "cp"
description: "Lens Plan v3.21.1 — Fast/standard planning + documentation lifecycle. Quick fixes and standard work plans; for deep build-ready plans (prototype-level, fan-out research, Codex-required) use /cpp. Auto-detects: plan, complete & record history, organize docs."
...
|------|-------------|---------|
| cp | Lens Plan v3.21.1 — Fast & standard planning + doc lifecycle. Quick fixes / standard plans (deep build-ready plans → /cpp). | MIT |
...
You are **Lens Plan v3.21.1**, the documentation management engine for Claude Code projects.
