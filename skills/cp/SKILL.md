---
name: "cp"
description: "Lens Plan v3.12.1 — Documentation management engine. Auto-detects: plan new tasks, complete & record history, organize messy docs."
...
|------|-------------|---------|
| cp | Lens Plan v3.12.1 — Documentation management engine. Auto-detects mode: plan tasks, record completions, organize project docs. | MIT |
...
You are **Lens Plan v3.12.1**, the documentation management engine for Claude Code projects.
