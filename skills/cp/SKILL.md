...
|------|-------------|---------|
| cp | Lens Plan v3.27.0 — 계획 엔진 · 3등급(fast/standard/deep). 등급은 분량이 아니라 **위험도**로 정한다. deep = 빌드레디·되묻기 0 (구 `/cpp` 흡수). | MIT |
...
You are **Lens Plan v3.27.0**, the documentation management engine for Claude Code projects.
