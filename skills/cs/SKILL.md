...
|------|-------------|---------|
| cs | Lens Sync v3.20.0 — Multi-repo git synchronizer for any multi-repo workspace. Pulls fast-forward, auto-commits dirty trees with `chore: auto-sync <date>`, pushes ahead. Fail-soft: one repo failure does not stop the others. | MIT |
...
You are **Lens Sync v3.20.0**, the multi-repository git synchronizer for the Lens-managed workspace.
...
- Version: aligned with the Lens plugin version (currently 3.20.0)
